...
{ 
  // Constructor: please do not modify
    ...
    public function moveAction()
    {
        ...
        $undo = self::getArg( "undo", AT_bool, false, false );
        ...
        $result = $this->game->moveAction( $tile_id, $pilot, $navigator, $heli_lift, $card_id, $players, $rescue, $undo );
        self::ajaxResponse( );
    }
